...
function calc() {
  ...
  this.getDerivative = function(f, xval){
    /*
     * This is a brute force method of calculating derivatives, using Newton's difference quotient (except without a limit)
     * The derivative of a function f and point x can be approximated by taking the slope of the secant from x to x+h, provided that h is sufficently small. 
     * However, if h is too small, then floating point errors may result.
     * This algorithm is an effective 100-point stencil in one dimension for calculating the derivative of any real function y=equation.
     */
    var ddx = 0;
  ...
  this.roundFloat = function(val) { //Stupid flaoting point in precision...
